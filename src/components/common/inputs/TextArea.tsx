    ...
    return (
      <div className={`flex flex-col gap-1.5 w-full ${containerClassName}`}>
        ...
        <textarea
          ...
          id={inputId}
          rows={rows}
          className={`w-full text-sm py-2 px-3.5 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 border rounded-lg outline-none transition-all duration-150 resize-y
            ${
              error
